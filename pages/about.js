      ...
      <main className={styles.main}>
        ...
        <div className={styles.character_container}>
          <div className={styles.row}>
              <Image className={styles.team_image} src={Rachel} height={80} width={80} />
          ...
          <div className={styles.row}>
            <Image className={styles.team_image} src={Sebin} height={80} width={80} />
            <div className={styles.text}>
              <h3>Sebin</h3>
              <h4>Front-end developer</h4>
          ...
          <div className={styles.row}>
            <Image className={styles.team_image} src={Meelaud} height={80} width={80} />
            <div className={styles.text}>
              <h3>Meelaud</h3>
